USE [master]
GO
/****** Object:  Database [AdventureworksDW2016CTP3]    Script Date: 10/6/2024 2:56:46 PM ******/
CREATE DATABASE [AdventureworksDW2016CTP3]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AdventureWorksDW2014_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2016CTP3_Data.mdf' , SIZE = 1501184KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
 LOG ON 
( NAME = N'AdventureWorksDW2014_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2016CTP3_Log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET COMPATIBILITY_LEVEL = 130
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [AdventureworksDW2016CTP3].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ANSI_NULLS ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ANSI_PADDING ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ANSI_WARNINGS ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ARITHABORT ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET CONCAT_NULL_YIELDS_NULL ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET QUOTED_IDENTIFIER ON 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET  DISABLE_BROKER 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET  MULTI_USER 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET DB_CHAINING OFF 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'AdventureworksDW2016CTP3', N'ON'
GO
...
USE [AdventureworksDW2016CTP3]
GO
/****** Object:  UserDefinedFunction [dbo].[udfBuildISO8601Date]    Script Date: 10/6/2024 2:56:46 PM ******/
SET ANSI_NULLS ON
GO
...
END;
GO
/****** Object:  UserDefinedFunction [dbo].[udfMinimumDate]    Script Date: 10/6/2024 2:56:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  UserDefinedFunction [dbo].[udfTwoDigitZeroFill]    Script Date: 10/6/2024 2:56:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [dbo].[DimCustomer]    Script Date: 10/6/2024 2:56:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimDate]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimGeography]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProduct]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProductCategory]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProductSubcategory]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimSalesTerritory]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactInternetSales]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vDMPrep]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vTimeSeries]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vTargetMail]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vAssocSeqOrders]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vAssocSeqLineItems]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AdventureWorksDWBuildVersion]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DatabaseLog]    Script Date: 10/6/2024 2:56:47 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimAccount]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimCurrency]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimDepartmentGroup]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimEmployee]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimOrganization]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimPromotion]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimReseller]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimSalesReason]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimScenario]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactAdditionalInternationalProductDescription]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactCallCenter]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactCurrencyRate]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactFinance]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactInternetSalesReason]    Script Date: 10/6/2024 2:56:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactProductInventory]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactResellerSales]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactResellerSalesXL_CCI]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[FactResellerSalesXL_CCI](
	...
	[DueDate] [datetime] NULL,
	[ShipDate] [datetime] NULL,
 CONSTRAINT [PK_FactResellerSalesXL_CCI_SalesOrderNumber_SalesOrderLineNumber] PRIMARY KEY NONCLUSTERED 
(
	[SalesOrderNumber] ASC,
	[SalesOrderLineNumber] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[FactResellerSalesXL_PageCompressed]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactSalesQuota]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactSurveyResponse]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NewFactCurrencyRate]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProspectiveBuyer]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_DimCurrency_CurrencyAlternateKey]    Script Date: 10/6/2024 2:56:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_DimCustomer_CustomerAlternateKey]    Script Date: 10/6/2024 2:56:49 PM ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_DimCustomer_CustomerAlternateKey] ON [dbo].[DimCustomer]
(
	[CustomerAlternateKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [AK_DimDate_FullDateAlternateKey]    Script Date: 10/6/2024 2:56:49 PM ******/
CREATE UNIQUE NONCLUSTERED INDEX [AK_DimDate_FullDateAlternateKey] ON [dbo].[DimDate]
(
	[FullDateAlternateKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [IndFactResellerSalesXL_CCI]    Script Date: 10/6/2024 2:56:49 PM ******/
CREATE CLUSTERED COLUMNSTORE INDEX [IndFactResellerSalesXL_CCI] ON [dbo].[FactResellerSalesXL_CCI] WITH (DROP_EXISTING = OFF, COMPRESSION_DELAY = 0) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_CCI_DimCurrency] FOREIGN KEY([CurrencyKey])
REFERENCES [dbo].[DimCurrency] ([CurrencyKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI] CHECK CONSTRAINT [FK_FactResellerSalesXL_CCI_DimCurrency]
GO
...
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_CCI_DimEmployee] FOREIGN KEY([EmployeeKey])
REFERENCES [dbo].[DimEmployee] ([EmployeeKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI] CHECK CONSTRAINT [FK_FactResellerSalesXL_CCI_DimEmployee]
GO
...
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_CCI_DimPromotion] FOREIGN KEY([PromotionKey])
REFERENCES [dbo].[DimPromotion] ([PromotionKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI] CHECK CONSTRAINT [FK_FactResellerSalesXL_CCI_DimPromotion]
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_CCI_DimReseller] FOREIGN KEY([ResellerKey])
REFERENCES [dbo].[DimReseller] ([ResellerKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI] CHECK CONSTRAINT [FK_FactResellerSalesXL_CCI_DimReseller]
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_CCI_DimSalesTerritory] FOREIGN KEY([SalesTerritoryKey])
REFERENCES [dbo].[DimSalesTerritory] ([SalesTerritoryKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_CCI] CHECK CONSTRAINT [FK_FactResellerSalesXL_CCI_DimSalesTerritory]
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimCurrency] FOREIGN KEY([CurrencyKey])
REFERENCES [dbo].[DimCurrency] ([CurrencyKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimCurrency]
GO
...
REFERENCES [dbo].[DimDate] ([DateKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate]
GO
...
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimEmployee] FOREIGN KEY([EmployeeKey])
REFERENCES [dbo].[DimEmployee] ([EmployeeKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimEmployee]
GO
...
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimPromotion] FOREIGN KEY([PromotionKey])
REFERENCES [dbo].[DimPromotion] ([PromotionKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimPromotion]
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimReseller] FOREIGN KEY([ResellerKey])
REFERENCES [dbo].[DimReseller] ([ResellerKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimReseller]
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed]  WITH CHECK ADD  CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimSalesTerritory] FOREIGN KEY([SalesTerritoryKey])
REFERENCES [dbo].[DimSalesTerritory] ([SalesTerritoryKey])
GO
ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] CHECK CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimSalesTerritory]
GO
...
GO
/****** Object:  DdlTrigger [ddlDatabaseTriggerLog]    Script Date: 10/6/2024 2:56:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [AdventureworksDW2016CTP3] SET  READ_WRITE 
GO
